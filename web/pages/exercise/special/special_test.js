...
Page({
  ...
  changeSwiper: function (e) {
    ...
    // var qesList = this.data.qesList
    // console.log(qesList.slice(currentId >= 1 ? currentId - 1 : 0, currentId + 2), this.data.qesListMini)
    this.setData({
      currentId: currentId,
      // qesListMini: qesList.slice(currentId >= 1 ? currentId - 1 : 0, currentId + 2)
    });
  ...
  onReady: function () {
    // 获取后台数据
    var _this = this
    var url = '/web/question/listByCategoryId';
    var data = {
